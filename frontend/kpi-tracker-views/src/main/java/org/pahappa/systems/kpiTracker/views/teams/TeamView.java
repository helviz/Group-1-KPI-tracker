...
public class TeamView extends PaginatedTableView<Team, TeamService, TeamService> {
    ...
    public void reloadFromDB(int first, int pageSize, Map<String, Object> filterBy) throws Exception {
        super.setDataModels(teamService.getInstances(new Search().addFilterEqual("recordStatus", RecordStatus.ACTIVE), first, pageSize));
    }
    ...
    public void reloadFilterReset() {
        super.setTotalRecords(teamService.countInstances(new Search()));
        try {
